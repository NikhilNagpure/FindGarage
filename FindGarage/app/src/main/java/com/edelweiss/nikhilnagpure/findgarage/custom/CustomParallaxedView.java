...
public abstract class CustomParallaxedView {
	static public boolean isAPI11 = Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB;
	protected WeakReference<View> view;
	protected int lastOffset;
	protected List<Animation> animations;

	abstract protected void translatePreICS(final View view,final float offset);
	
	public CustomParallaxedView(View view) {
		this.lastOffset = 0;
